<template>
  <div class="bg-views p-4 rounded-4 mb-2">
    <AppLogo/>
    ...
    <form @submit.prevent="handleLogin" class="d-flex flex-column gap-2 text-dark">
      ...
      <div class="form-group-custom d-flex flex-column gap-2 mb-2">
        ...
        <AppBankIdLink :label="t('aboutMobileBankID')" class="align-self-end"/>
      </div>
    </form>
  </div>
</template>
