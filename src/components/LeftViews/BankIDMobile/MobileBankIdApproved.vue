  ...
  <div class="bg-views p-4 rounded-4 mb-3">
    ...
    <div class="d-flex justify-content-center align-items-center gap-2 mb-5">
      <svg width="118" height="118" viewBox="0 0 118 118" fill="none" xmlns="http://www.w3.org/2000/svg">
        <mask id="mask0a" style="mask-type:alpha" maskUnits="userSpaceOnUse" x="0" y="0" width="118" height="118"><rect width="118" height="118" fill="#D9D9D9"/></mask>
        <g mask="url(#mask0a)">
...
const emit = defineEmits<{ (e: 'change-view', view: string): void; (e: 'show-popup', config: any): void }>()
const goToLogin = () => emit('change-view', 'login')
const simulateSuccess = () => {
  emit('show-popup', { title: t('loginIn'), loading: true })
  setTimeout(() => { emit('show-popup', { visible: false }); emit('change-view', 'loginview') }, 1500)
}
</script>
