<template>
  <div class="bg-views p-4 rounded-4 mb-3">
    ...
    <button @click="goToBankIdDevice" class="btn-custom d-flex align-items-center justify-content-start gap-2 mb-3">
    ...
    <div v-if="isDev" class="d-flex flex-column gap-2 mt-2">
      ...
      <button @click="$emit('trigger-error')" class="btn-temp">
