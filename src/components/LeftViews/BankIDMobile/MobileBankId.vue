<template>
  <div class="bg-views p-4 rounded-4 mb-3">
    ...
    <button @click="$emit('change-view','bankiddevice')" class="btn-custom d-flex align-items-center justify-content-start gap-2 mb-3">
    ...
    <div v-if="isDev" class="d-flex flex-column gap-2 mt-4">
      <button @click="simulatePending" class="btn-temp">
