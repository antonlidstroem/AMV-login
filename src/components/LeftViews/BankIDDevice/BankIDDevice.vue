<template>
  <div class="bg-views p-4 rounded-4 mb-3">
    ...
    <button @click="$emit('change-view','mobilebankid')" class="btn-custom d-flex align-items-center justify-content-start gap-2 mb-3" type="button">
      <img :src="bankIdLogo" width="25" height="24" alt="BankID" />
      {{ t('mobileBankID') }}
    </button>
    <button v-if="isDev" @click="$emit('change-view','bankiddeviceapproved')" class="btn-temp" type="button">Simulera lyckad inloggning</button>
  </div>
</template>
<script lang="ts">
