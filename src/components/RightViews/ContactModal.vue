<template>
  <div class="contact-panel position-relative rounded-4 text-white p-4 border border-white"
    style="background-color: rgba(100,100,100,0.80); width: 95%; max-width: 900px; max-height: 85%; margin: auto; display: flex; flex-direction: column; overflow-y: auto;">
    ...
    <div class="contact-person rounded-3 p-3 mb-4 flex-shrink-0 border border-white" style="background-color: rgba(128,172,47,0.15);">
    ...
    <form @submit.prevent="sendContact" class="d-flex flex-column gap-2 flex-grow-1">
      ...
      <div class="position-relative mb-2">
        <i class="bi bi-person-vcard position-absolute text-white" style="left:12px;top:50%;transform:translateY(-50%);font-size:1.2rem;opacity:0.6;"></i>
      ...
      <div class="position-relative mb-2">
        <i class="bi bi-envelope position-absolute text-white" style="left:12px;top:50%;transform:translateY(-50%);font-size:1.2rem;opacity:0.6;"></i>
