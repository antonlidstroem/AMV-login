  ...
  >
    ...
    >
      <p class="mb-2" style="color:#ffffff !important;">
        <i class="bi bi-person-fill me-2"></i><strong class="text-white">Emanuel Makhoul</strong>
      </p>
      <p class="mb-2" style="color:#ffffff !important;">
        <i class="bi bi-envelope me-2"></i>emanuel@arbetsmiljoverktyget.se
      </p>
      <p class="mb-0" style="color:#ffffff !important;">
        <i class="bi bi-telephone me-2"></i>+4670 112
      </p>
    </div>
...
const sendContact = async () => {
  ...
  try {
    ...
    popup.show({
      ...
      buttons: [{
        label: t('okClose'),
        action: () => { popup.hide(); ui.closeOverlays() },
      }],
    })
  } catch {
    popup.show({
